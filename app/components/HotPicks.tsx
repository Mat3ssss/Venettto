...
const items = [
  ...
  { name: "Kuřecí Pizza", price: "240,-", desc: "smetana | sýr | šunka | kuřecí maso | špenát | česnek", img: "/kure.jpeg" },
  { name: "Cheese Burger", price: "259,-", desc: "bulka | hovězí maso | dip | salát | rajče | okurka | cheddar", img: "/hotpicture.png" },
];
